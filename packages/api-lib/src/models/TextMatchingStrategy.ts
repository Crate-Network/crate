...
export function TextMatchingStrategyFromJSON(json: any): TextMatchingStrategy {
    return TextMatchingStrategyFromJSONTyped(json, false);
}

export function TextMatchingStrategyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TextMatchingStrategy {
    return json as TextMatchingStrategy;
}

export function TextMatchingStrategyToJSON(value?: TextMatchingStrategy | null): any {
    return value as any;
}
